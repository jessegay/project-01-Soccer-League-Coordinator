...
// Create constants for team names and practice times. Not super useful, but if we wrote more involved letters or wanted to use this template for other teams it could be useful.
...
// Create one letter for each team, add too letters array.
